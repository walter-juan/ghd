...
import com.woowla.ghd.data.local.room.entities.fromDeployment
...
fun Deployment.toDbDeployment() = DbDeployment.fromDeployment(this)
...
fun List<Deployment>.toDbDeployment() = map { DbDeployment.fromDeployment(it) }
