...
object DeploymentsScreen {
                        ...
                        if (state.deployments.isEmpty()) {
                            ...
                            ListDeployments(
                                ...
                                onOpenClick = { repoToCheck ->
                                    repoToCheck.repository?.deploymentsUrl?.let(::openWebpage)
                                }
                            )
                        }
                    }
    ...
    @Composable
    private fun ListDeployments(
        deployments: List<Pair<RepoToCheck, Map<String, List<Deployment>>>>,
        ...
        FlowRow(
            ...
            deployments.forEach { (repoToCheck, map) ->
                map.forEach { (groupKey, deployments) ->
                    DeploymentCard(
