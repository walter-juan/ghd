...
import com.woowla.ghd.domain.entities.groupByGroupKeys
...
class DeploymentsStateMachine(
            ...
            deploymentService.getAll()
                .fold(
                    onSuccess = { deployments ->
                        state.override {
                            St.Success(
                                deployments = deployments.groupByGroupKeys(),
    ...
    sealed interface St {
        ...
        data class Success(
            val deployments: List<Pair<RepoToCheck, Map<String, List<Deployment>>>>,
