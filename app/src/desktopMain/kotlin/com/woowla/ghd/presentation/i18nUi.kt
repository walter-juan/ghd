package com.woowla.ghd.presentation
...
internal object i18nUi {
    ...
    val screen_notifications_test_section = "Test notifications"
    val screen_notifications_test_title = "Send test notification"
    val screen_notifications_test_description = "Send a notification through the same desktop notification path used for pull request and release updates."
    val screen_notifications_test_action = "Send test notification"
    val screen_notifications_test_sent = "Test notification sent to the desktop notification service."
    val screen_notifications_test_notification_title = "GHD test notification"
    val screen_notifications_test_notification_message = "Desktop notifications are connected."
