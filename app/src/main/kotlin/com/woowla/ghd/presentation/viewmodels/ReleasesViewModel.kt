...
class ReleasesViewModel(
            ...
            releaseService.getAll()
                .fold(
                    onSuccess = { releases ->
                        ...
                        _state.value = State.Success(groupedReleases = groupedReleases, syncResultWithEntries = syncResult, appSettings = appSettings)
                    },
                    onFailure = {
    ...
    sealed class State {
        ...
        data class Success(val groupedReleases: List<GroupedReleases>, val syncResultWithEntries: SyncResultWithEntriesAndRepos?, val appSettings: AppSettings?): State()
