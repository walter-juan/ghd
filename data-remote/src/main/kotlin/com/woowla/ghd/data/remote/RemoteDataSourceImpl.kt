...
class RemoteDataSourceImpl(
    ...
    override suspend fun getPullRequests(repoToCheck: RepoToCheck, state: PullRequestState): Result<ApiResponse<List<PullRequestWithRepoAndReviews>>> {
        return runCatching {
            ...
            val data = pullRequestsResponse
                ...
                ?.edges
                ?.mapNotNull { it?.node }
                ?.map { it.toPullRequest(repoToCheck) }
                ?: listOf()
